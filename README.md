...
Place the `comments` folder along with its contents to the `plugins` folder. Then update your `config.php` file:
...
<?php
    return array(
        ...
        'comments_config' => array(
            ...
            'spam_keywords' => 'buy twitter fol,buy,cheap,add your own banning text here,another banning text here',
...
Add this snippet to your `blog_post.html` that placed in your `themes` folder to show the comments area:
